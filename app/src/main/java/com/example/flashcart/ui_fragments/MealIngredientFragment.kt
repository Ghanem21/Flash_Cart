...
class MealIngredientFragment : Fragment() {
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_meal_ingredient, container, false)
    ...
    private fun setupRecyclerView(view: View?) {
        ...
        val recyclerView = view?.findViewById<RecyclerView>(R.id.meal_ingredient_recycler_view)
